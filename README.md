...
dataset on its own. The tool answers seven kinds of question. The first five go
in increasing order of depth; the last two are lookups rather than estimates,
and differ in what they can see:
